  ...
  return (
    <main className={`app-shell ${sidebarCollapsed ? "sidebar-hidden" : ""}`}>
      <aside className={`sidebar ${sidebarOpen ? "sidebar-open" : ""}`}>
        ...
        <div className="sidebar-note"><Info size={15} /><span>原文件保存在 ResourceSpace；项目只保存素材引用与分类数据。</span></div>
      </aside>
      ...
      >
        ...
        <header className="topbar">
          ...
          <div className="status-pill"><span className="status-dot" /> ResourceSpace 已连接</div>
        </header>
